...
|---|---|---|
| Row count accuracy | 33% | 83% |
| Top result accuracy | 42% | 75% |
| Join correctness | 67% | 100% |
| EXPLAIN verified | 92% | 92% |
| Average score (0–4) | 2.33 | 3.5 |
...
| Q02 | multi_entity_join | 0/4 | 3/4 | A-err: No join path found from entity:rental to entity:pa |
| Q03 | complex_join | 2/4 | 4/4 | — |
| Q04 | single_entity_aggregation | 3/4 | 4/4 | — |
| Q05 | multi_entity_join | 2/4 | 4/4 | — |
| Q06 | complex_join | 2/4 | 4/4 | — |
| Q07 | temporal_aggregation | 2/4 | 1/4 | B-err: EXPLAIN failed: column i.rental_duration does not  |
| Q08 | null_trap | 3/4 | 2/4 | Boyce: INNER JOIN (drops rows); Direct: INNER JOIN (drops rows) |
| Q09 | dialect_safety | 3/4 | 4/4 | Boyce: uses ||; Direct: used CONCAT() |
| Q10 | filter_aggregation | 2/4 | 4/4 | — |
| Q11 | simple_aggregation | 2/4 | 4/4 | — |
| Q12 | complex_join_with_filter | 3/4 | 4/4 | — |
