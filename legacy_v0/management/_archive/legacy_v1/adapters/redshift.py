"""
Redshift database adapter for DataShark.

Implements the DatabaseAdapter interface for Amazon Redshift.
"""
...
class RedshiftAdapter(DatabaseAdapter):
    """Amazon Redshift adapter using psycopg2."""
    ...
    def supports_batch_extraction(self) -> bool:
        """Redshift supports batch extraction."""
        return True
