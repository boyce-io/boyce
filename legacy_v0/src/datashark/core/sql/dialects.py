...
class BigQueryDialect(SQLDialect):
    ...
    def render_date_trunc(self, field: str, unit: str) -> str:
        ...
        # BigQuery DATE_TRUNC signature: DATE_TRUNC(date_expression, date_part)
        # date_part must be: DATE, WEEK, MONTH, QUARTER, YEAR
        unit_upper = unit.upper()
        # Map common units to BigQuery date_part values
        date_part_map = {
            "DAY": "DATE",
            "WEEK": "WEEK",
            "MONTH": "MONTH",
